...
function TrainerSideBar() {
  ...
  return (
    <div className="b text-light d-flex flex-column align-items-center py-3" style={{ width: "60px", backgroundColor: "#101113" }}>
      <div className="mb-4">
        <FaDumbbell 
          className={`fs-2 ${isActive("/trainer-console") ? "text-white" : "text-secondary"}`} 
      ...
      <ul className="nav flex-column text-center">
        <li className="nav-item my-3">
          <FaHome 
            className={`fs-4 ${isActive("/trainer-console") ? "text-white" : "text-secondary"}`} 
            onClick={() => navigate("/trainer-console")} 
          />
        </li>
        <li className="nav-item my-3">
          <FaUsers 
            className={`fs-4 ${isActive("/trainer-profile") ? "text-white" : "text-secondary"}`} 
            onClick={() => navigate("/trainer-profile")} 
          />
        </li>
        <li className="nav-item my-3">
          <IoIosSend 
            className={`fs-4 ${isActive("/trainer-chat") ? "text-white" : "text-secondary"}`} 
